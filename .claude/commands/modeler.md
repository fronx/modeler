...
# Note: timestamps are auto-generated by the API if not provided
...
curl -X POST http://localhost:3000/api/spaces/SPACE_ID/thoughts \
  ...
  -d '{
    ...
    "meanings": [{"content": "AI capabilities and limitations", "confidence": 0.9}],
    "focus": 1.0,
    "semanticPosition": -0.5,
...
curl -X POST http://localhost:3000/api/spaces/SPACE_ID/thoughts \
  ...
  -d '{
    ...
    "meanings": [{"content": "Areas of AI-human collaboration", "confidence": 0.9}],
    "focus": 1.0,
    "checkableList": [
