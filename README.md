...
**For AI Systems:**
```bash
# Create and execute cognitive modeling spaces
...
3. **Execute Space**
   ...
   This will:
   - Find your TypeScript file in the space directory
...
- **Space-based API**: Use the `Session` class from `src/lib/thought-system` for new cognitive models
...
2. **[`docs/examples/simple-space.ts`](docs/examples/simple-space.ts)** - Quick start example
