...
type NodeId = string;
type RelationType = 'causes' | 'supports' | 'contradicts' | 'means' | 'becomes' | 'observes' | 'enables' | 'builds-on' | 'transcends' | 'challenges' | 'implements' | 'fulfills' | 'validates' | 'based-on';
...
export { ThoughtSpace, ThoughtNode };

// Create a default space for immediate use
export const space = new ThoughtSpace();
export const thought = (id: NodeId) => space.thought(id);